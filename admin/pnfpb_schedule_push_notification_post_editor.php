<?php
			...
			if ( empty($onetime_push_date_field_timestamp)) {
				...
				$onetime_push_date_field = date('Y-m-d',$onetime_push_date_field_timestamp);
			...
			if (empty($onetime_push_time_field_timestamp)) {
				...
				$onetime_push_time_field = date('H:i:s',$onetime_push_time_field_timestamp);
      		...
      		<fieldset id="pnfpb_push_notification_send_layout">
				...
				<br/><br/>
  				<div class="pnfpb_column_400 pnfpb_schedule_push_notification_post_editor">
						<label for="pnfpb_schedule_push_notification_post_editor" class="post-format-icon pnfpb_schedule_push_notification_post_editor_label"><?php echo __("Schedule push notification",'PNFPB_TD');?></label>
						<br/><br/>
						<label><?php echo get_post_meta($post->ID,'pnfpb_post_schedule',true); ?></label>					
    					<div class="pnfpb_schedule_later_ondemand">
							...
							<br/>
							<input  id="pnfpb_ic_fcm_token_ondemand_datepicker_post" name="pnfpb_ic_fcm_token_ondemand_datepicker_post" type="date" value="<?php if ($onetime_push_date_field != '') { echo $onetime_push_date_field; } ?>" />
							<br/><br/>
							...
							<br/>
							<input  id="pnfpb_ic_fcm_token_ondemand_timepicker_post" name="pnfpb_ic_fcm_token_ondemand_timepicker_post" type="time" value="<?php if ($onetime_push_time_field != '') { echo $onetime_push_time_field; } ?>" />
							<br/><br/>
