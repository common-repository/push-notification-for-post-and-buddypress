  					...
  					<div class="pnfpb_column">
    					<div class="pnfpb_card">
							...
							<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_fcm_post_schedule_now_enable">
								<?php echo __("Send notification in action scheduler asynchronous background mode to avoid server overload.<br/>(Enable this when more number of subscribers or notifications, it will take 30 to 60 seconds for batch process)",'PNFPB_TD');?>
							</label>
						</div>
					</div>
			</div>
  					...
  					<div class="pnfpb_column">
    					<div class="pnfpb_card">
							<label class="pnfpb_ic_push_settings_table_label_checkbox" for="pnfpb_ic_fcm_post_schedule_enable">
								<?php echo __("Schedule",'PNFPB_TD').'<br/>'.__("in action scheduler",'PNFPB_TD');?>
							</label>
							<?php
...
<h2 class="pnfpb_ic_push_settings_header2"><?php echo __("Firebase API httpv1",'PNFPB_TD');?></h2>
<p><?php echo __('(Enable below option to use latest version of Firebase API - http v1. Recommended PHP version for this is 8.0 or above. It will work with PHP version 7.4 but recommended PHP version is 8.0 to use latest version of Firebase API httpv1)','PNFPB_TD') ?></p>
							...
							<div class="pnfpb_column_400">
    							<div class="pnfpb_card">
									<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_flex_grow_6 pnfpb_padding_top_8 pnfpb_max_width_236" for="pnfpb_ic_fcm_latest_firebase_v1_enable">
										<?php echo __("Firebase api httpv1",'PNFPB_TD');?>
									</label>
									<label class="pnfpb_switch pnfpb_flex_grow_1 pnfpb_margin_top_8 pnfpb_margin_left_4 pnfpb_max_width_40">
...
<h2 class="pnfpb_ic_push_settings_header2"><?php echo __("Use Firebase (or) Onesignal (or) Progressier (and / or) webtoapp.design as push notification provider",'PNFPB_TD');?></h2>
<p><?php echo __("<b>webtoapp.design</b> push notification is for Android/IOS mobile app, if webtoapp.design push notifications is enabled then it will also work along with Firebase/Onesignal notifications by enabling Firebase/Onesignal along with webtoapp.design to send notifications to desktop also to mobile app generated from webtoapp.design",'PNFPB_TD')." <a href='https://webtoapp.design/' target='_blank'>https://webtoapp.design/</a> ";?></p>
<div class="pnfpb_column_full">
...
<div class="pnfpb_ic_firebase_configuration_help">
	...
	<ul>
		...
		<div class="pnfpb_column_full">
			...
			<button type="button" class="pnfpb_ic_webtoapp_configuration_button" onclick="toggle_webtoapp_configuration()"><?php echo __("Webtoapp.design configuration",'PNFPB_TD'); ?></button>
		</div>
	...
	<div class="pnfpb_ic_webtoapp_configuration">
		<h3>
			<?php echo __("Webtoapp.design push notification configuration",'PNFPB_TD');?>	
		</h3>
		<p>
			<?php echo __("If Webtoapp.design is enabled then, <b>it requires webtoapp api key from your webtoapp.design account</b>",'PNFPB_TD'); ?>
		</p>
		<p>
			<?php echo __("Get webtoapp.design API key here",'PNFPB_TD')." <a href='https://webtoapp.design/' target='_blank'>https://webtoapp.design/</a> "; ?>
		</p>
		<p><?php echo __("<b>webtoapp.design</b> push notification is for Android/IOS mobile app, if webtoapp.design push notifications is enabled then it will also work along with Firebase/Onesignal notifications by enabling Firebase/Onesignal along with webtoapp.design to send notifications to desktop also to mobile app generated from webtoapp.design",'PNFPB_TD')." <a href='https://webtoapp.design/' target='_blank'>https://webtoapp.design/</a> ";?></p>		
		<table class="pnfpb_ic_push_notification_settings_table widefat fixed" cellspacing="0">
    		<tbody>
								...
								<div class="pnfpb_card">
									<label class="pnfpb_ic_push_settings_table_label_checkbox pnfpb_padding_top_8" for="pnfpb_onesignal_push">
										<label class="pnfpb_switch">
											...
											<?php echo __("Use Webtoapp.design to send PUSH notification",'PNFPB_TD');?>
									</label>
								</div>
								<div>
									<?php echo __("If enabled, it will use Webtoapp.design to send push notification",'PNFPB_TD');?>
									<br />
									<?php echo __("Post, Custom post types, BuddyPress Activities, Group activities, Private message, Friendship request/accept and Front end BuddyPress notification settings are available for Webtoapp.design push notification",'PNFPB_TD');?>
									<br />
								</div>						
							</div>
						</div>
				...
				<tr class="pnfpb_ic_push_settings_table_row">
        			<td class="pnfpb_ic_push_settings_table_label_column column-columnname">
						<label for="pnfpb_ic_fcm_webtoapp_api_key"><?php echo __("Webtoapp.design API key",'PNFPB_TD');?></label>
						<br/>
...
<div id="pnfpb-admin-right_sidebar" class="pnfpb_column_left_300 pnfpb-admin-right_sidebar" >
	...
	<h4><?php echo __("Contribute/Donate",'PNFPB_TD');?></h4>
	<p><a href="https://www.muraliwebworld.com/support-to-push-notification-plugin-for-buddypress-and-for-post/"><?php echo __("Donate/Contribute to this plugin",'PNFPB_TD');?></a></p>
